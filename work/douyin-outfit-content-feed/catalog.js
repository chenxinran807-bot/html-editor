...
const rawCards = [
  ['creator', 'creator-1', '清爽通勤灵感', ['通勤', '简洁'], ['推荐', '通勤'], ['不限性别', '男生', '宽肩'], ['精选', '关注', '男生穿搭'], { reason: '配色清晰，适合日常参考', authorId: 'author-1', authorName: '简线穿搭' }],
  ...
  ['creator', 'creator-2', '校园活力日记', ['校园', '活力'], ['校园'], ['男生', '小个子'], ['新锐', '男生穿搭'], { reason: '比例利落，适合校园活动', authorId: 'author-2', authorName: '晴日衣橱' }],
  ...
  ['creator', 'creator-3', '小个子通勤笔记', ['通勤', '比例'], ['通勤'], ['女生', '小个子'], ['关注', '女生穿搭'], { reason: '纵向线条明确，搭配易参考', authorId: 'author-3', authorName: '比例笔记' }],
  ...
  ['creator', 'creator-4', '冷色约会提案', ['约会', '冷色'], ['约会'], ['冷肤色', '不限性别'], ['精选', '新锐'], { reason: '冷色搭配干净，视觉节奏舒缓', authorId: 'author-4', authorName: '冷调搭配' }],
